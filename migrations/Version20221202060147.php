 ...
 */
final class Version20221202060147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE choice (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, proposal_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL, CONSTRAINT FK_C1AB5A92F4792058 FOREIGN KEY (proposal_id) REFERENCES questions (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_C1AB5A92F4792058 ON choice (proposal_id)');

 ...
 */
final class Version20221202012643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mst (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, mortality DOUBLE PRECISION DEFAULT NULL, transmission VARCHAR(255) NOT NULL, symptom VARCHAR(255) NOT NULL)');
